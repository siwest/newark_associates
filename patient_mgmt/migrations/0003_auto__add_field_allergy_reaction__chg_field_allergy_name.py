...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field allergy on 'Patient'
        m2m_table_name = db.shorten_name(u'patient_mgmt_patient_allergy')
        ...
        db.create_unique(m2m_table_name, ['patient_id', 'allergy_id'])

        # Adding field 'Allergy.reaction'
        db.add_column(u'patient_mgmt_allergy', 'reaction',
                      self.gf('django.db.models.fields.CharField')(default='anaphylaxis', max_length=100),
                      keep_default=False)
        ...
        # Changing field 'Allergy.name'
        db.alter_column(u'patient_mgmt_allergy', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Removing M2M table for field allergy on 'Patient'
        db.delete_table(db.shorten_name(u'patient_mgmt_patient_allergy'))

        # Deleting field 'Allergy.reaction'
        db.delete_column(u'patient_mgmt_allergy', 'reaction')
        ...
        # Changing field 'Allergy.name'
        db.alter_column(u'patient_mgmt_allergy', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
