...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Drug_Interaction.interaction'
        db.delete_column(u'patient_mgmt_drug_interaction', 'interaction')

        # Adding field 'Drug_Interaction.effect'
        db.add_column(u'patient_mgmt_drug_interaction', 'effect',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Drug_Interaction.interaction'
        db.add_column(u'patient_mgmt_drug_interaction', 'interaction',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'Drug_Interaction.effect'
        db.delete_column(u'patient_mgmt_drug_interaction', 'effect')
