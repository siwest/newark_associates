...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Admission.procedure'
        db.add_column(u'patient_mgmt_admission', 'procedure',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['patient_mgmt.Procedure']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Admission.procedure'
        db.delete_column(u'patient_mgmt_admission', 'procedure_id')
